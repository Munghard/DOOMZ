...
void UHorizonButtonUserWidget::NativeDestruct()
{
	...
	if (Button_Main)
	{
		Button_Main->OnPressed.RemoveAll(this);
		Button_Main->OnReleased.RemoveAll(this);
		Button_Main->OnClicked.RemoveAll(this);
		Button_Main->OnHovered.RemoveAll(this);
		Button_Main->OnUnhovered.RemoveAll(this);
